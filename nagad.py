...
def run(playwright: Playwright) -> None:
    username = config("NAGAD_USER")
    password = config("NAGAD_PASS")
    ...
    output_file = output_dir / f"payment_history_{target_date_display}.xlsx"
...
def run_nagad():
    print("🚀 Starting Nagad Automation...")
    with sync_playwright() as playwright:
        run(playwright)
    print("✅ Nagad Automation Completed!")
