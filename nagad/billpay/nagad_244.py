...
def run(playwright: Playwright) -> None:
    username = config("NAGAD_USER_02")
    password = config("NAGAD_PASS_02")
    ...
    page.get_by_label("Service Name*").select_option("4022")
    ...
    output_file = output_dir / f"payment_history_244_{target_date_display}.xlsx"
...
def run_nagad_244():
    print("🚀 Starting Nagad 244 Automation...")
    with sync_playwright() as playwright:
        run(playwright)
    print("✅ Nagad 244 Automation Completed!")
